...
<div class="container">
    ...
    <a href="/posts/{{ $posts[0]->slug }}" style="text-decoration: none; background-color: blue; color: white; padding: 5px; border-radius: 5px">Read More...</a>
...
<div class="container">
    <div class="row">
     ...
     @foreach ($posts->skip(1) as $post) <!-- skip digunakan utk melewati isi database 
        supaya tdk tampil sesuai yg diinginkan-->
